...
See `GizJSONModel` protocol for custom methods.
...
Sample Code:
    ...
    ********************** json convertor *********************
@code
    @interface GizAuthor : NSObject
    @property (nonatomic, strong) NSString *name;
    @property (nonatomic, assign) NSDate *birthday;
    @end
    @implementation GizAuthor
    @end

    @interface GizBook : NSObject
    @property (nonatomic, copy) NSString *name;
    @property (nonatomic, assign) NSUInteger pages;
    @property (nonatomic, strong) GizAuthor *author;
    @end
    @implementation GizBook
    @end
   
    int main() {
        // create model from json
        GizBook *book = [GizBook giz_modelWithJSON:@"{\"name\": \"Harry Potter\", \"pages\": 256, \"author\": {\"name\": \"J.K.Rowling\", \"birthday\": \"1965-07-31\" }}"];

        // convert model to json
        NSString *json = [book giz_modelToJSONString];
...
@code
    @interface GizShadow :NSObject <NSCoding, NSCopying>
    @property (nonatomic, copy) NSString *name;
    @property (nonatomic, assign) CGSize size;
    @end

    @implementation GizShadow
    - (void)encodeWithCoder:(NSCoder *)aCoder { [self giz_modelEncodeWithCoder:aCoder]; }
    - (id)initWithCoder:(NSCoder *)aDecoder { self = [super init]; return [self giz_modelInitWithCoder:aDecoder]; }
    - (id)copyWithZone:(NSZone *)zone { return [self giz_modelCopy]; }
    - (NSUInteger)hash { return [self giz_modelHash]; }
    - (BOOL)isEqual:(id)object { return [self giz_modelIsEqual:object]; }
    @end
@endcode

*/

@interface NSObject (GizJSONModel)
 ...
 */
+ (nullable instancetype)giz_modelWithJSON:(id)json;
...
/**
 ...
 property, this method will try to convert the value based on these rules:
     ...
     `NSString` -> SEL, Class.
 */
+ (nullable instancetype)giz_modelWithDictionary:(NSDictionary *)dictionary;
 ...
 */
- (BOOL)giz_modelSetWithJSON:(id)json;
...
/**
 ...
 @return Whether succeed.
 */
- (BOOL)giz_modelSetWithDictionary:(NSDictionary *)dic;
 ...
 */
- (nullable id)giz_modelToJSONObject;
 ...
 */
- (nullable NSData *)giz_modelToJSONData;
...
/**
 ...
 inner object to json string.
 */
- (nullable NSString *)giz_modelToJSONString;
 ...
 */
- (void)giz_modelEncodeWithCoder:(NSCoder *)aCoder;
...
/**
 ...
 @return self
 */
- (id)giz_modelInitWithCoder:(NSCoder *)aDecoder;
 ...
 */
- (BOOL)giz_modelIsEqual:(id)model;
 ...
 */
@interface NSArray (GizJSONModel)
 ...
 */
+ (nullable NSArray *)giz_modelArrayWithClass:(Class)cls json:(id)json;
 ...
 */
@interface NSDictionary (GizJSONModel)
 ...
 */
+ (nullable NSDictionary *)giz_modelDictionaryWithClass:(Class)cls json:(id)json;
@end
 ...
 */
@protocol GizJSONModel <NSObject>
@optional
...
/**
 ...
 object will be add to the array/set/dictionary.
  ...
  Example:
  @code
        @class GizShadow, GizBorder, GizAttachment;
 
        @interface GizAttributes
        @property NSString *name;
        ...
        @implementation GizAttributes
        + (NSDictionary *)modelContainerPropertyGenericClass {
            return @{@"shadows" : [GizShadow class],
                     @"borders" : GizBorder.class,
                     @"attachments" : @"GizAttachment" };
        }
        @end
  @endcode
...
/**
 ...
 Example:
 @code
        @class GizCircle, GizRectangle, GizLine;
 
        @implementation GizShape
        + (Class)modelCustomClassForDictionary:(NSDictionary*)dictionary {
            if (dictionary[@"radius"] != nil) {
                return [GizCircle class];
            } else if (dictionary[@"width"] != nil) {
                return [GizRectangle class];
            } else if (dictionary[@"y2"] != nil) {
                return [GizLine class];
            } else {
                return [self class];
            }
        }
