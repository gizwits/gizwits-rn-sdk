...
*/
 - (void)didCheckDeviceUpdate:(GizWifiDevice* _Nullable)device result:(GizError* _Nonnull)result wifiVersion:(NSDictionary <NSString*, NSString*>* _Nullable)wifiVersion mcuVersion:(NSDictionary <NSString*, NSString*>* _Nullable)mcuVersion;
...
*/
 - (void)didUpgradeDevice:(GizWifiDevice* _Nullable)device result:(GizError* _Nonnull)result firmwareType:(GizOTAFirmwareType)firmwareType;
...
*/
 - (void)didNotifyDeviceUpgradeStatus:(GizWifiDevice* _Nullable)device firmwareType:(GizOTAFirmwareType)firmwareType upgradeStatus:(GizError* _Nonnull)upgradeStatus;
...
/**
 ...
 @param token 用户token
 @param device 待检查的设备
 @see 回调 [GizDeviceOTADelegate didCheckDeviceUpdate:result:wifiVersion:mcuVersion:]
*/
...
/**
 ...
 @param token 用户token
 @param device 要升级的设备
 @see 回调 [GizDeviceOTADelegate didUpgradeDevice:result:firmwareType:]
*/
